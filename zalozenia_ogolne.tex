...
\item[Depesza METAR] --  format raportu o~pogodzie używany w~meteorologii lotniczej i~prognozie pogody.
\item[Depesza NOTAM] -- depesza zawierająca informacje (nt. ustanowienia, stanu lub zmian urządzeń lotniczych, służb, procedur, a~także o~niebezpieczeństwie), których znajomość we właściwym czasie jest istotna dla personelu związanego z~operacjami lotniczymi.
